package com.hs.solutions.Hstimecheck.detail
...
class ProdutoDetalheActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        produto = com.hs.solutions.Hstimecheck.MainActivityGlobalRepo.getProdutoById(id)
    ...
    private fun adicionarHistorico(evento: String, detalhe: String?) {
        ...
        produto?.historico?.add(
            com.hs.solutions.Hstimecheck.models.HistoricoItem(
                dataEvento = data,
                evento = evento,
                detalhe = detalhe,
